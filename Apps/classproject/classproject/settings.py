...
SECRET_KEY = 'p@n@9be$p5m=^#r_tj*u5)h#sbr)vm=m6kp(y-+w4v_!mdm0_x'
...
TEMPLATES = [
    {
        ...
        #'DIRS': ['onlineapp/template_clone', 'templates'],
        'DIRS':[],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#     'NAME':     'localhost/1521/AdityaDBase',
#     'USER':     'system',
#     'PASSWORD': 'Aditya22091998',
#   }
# }
